...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Fitness Studio Franchise Dashboard"
      subtitle="One merged fitness studio franchise view for Records, Workspaces, Requests, Cases, Schedules, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared fitness studio franchise jobs into one surface. Records, Workspaces, Requests, Cases, Schedules, Resources, documents, audit, and AI are presented as platform features.</div>
