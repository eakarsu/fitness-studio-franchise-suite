export const AUTH_COOKIE = 'fitness_studio_franchise_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@fitness-studio-franchise.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@fitness-studio-franchise.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@fitness-studio-franchise.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
