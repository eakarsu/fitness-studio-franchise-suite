...
PORT="${PORT:-5240}"
DB_NAME="${PGDATABASE:-fitness_studio_franchise_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Fitness Studio Franchise Suite"
echo "======================================="
echo
...
echo "Starting fitness studio franchise suite frontend on http://localhost:$PORT"
echo "Login: admin@fitness-studio-franchise.local / admin123"
